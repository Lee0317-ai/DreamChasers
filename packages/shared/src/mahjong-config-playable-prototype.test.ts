...
describe("胡了卜配置试玩原型页面边界", () => {
  ...
  it("支持高阶周目首版入口，并把周目参数透传到壳层", () => {
    ...
    expect(playHtml).toContain("高阶构筑：河杠连锁");
    expect(playHtml).toContain("高阶构筑：收官定局");
    expect(playHtml).toContain("高阶构筑：顺手成胡");
    expect(playHtml).toContain("高阶构筑：稳压续命");
    expect(playHtml).toContain("河杠流");
    expect(playHtml).toContain("收官流");
    expect(playHtml).toContain("顺手胡流");
    expect(playHtml).toContain("救场流");
    expect(playHtml).toContain("封盘护河");
    expect(playHtml).toContain("杠河双响");
    expect(playHtml).toContain("尾巡定局");
    expect(playHtml).toContain("稳手成胡");
    expect(playHtml).toContain("续战筹码");
